...
public class UploadController {
	...
	public String simple(Model model, @RequestParam("f") MultipartFile part, HttpServletRequest
	request) {
	...
	public String multi(Model model, @RequestParam("f") MultipartFile[] parts, HttpServletRequest
	request) {
	String path = request.getServletContext().getRealPath("/upload/");
	try {
